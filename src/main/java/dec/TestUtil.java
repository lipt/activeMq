...
public class TestUtil {
    public static void main(String[] args) throws Exception {
        TestUtil tarUtil = new TestUtil();
        tarUtil.testTar();
        // tar(new File("D:/log/2017back.txt"), new File("D:/log/2018back.tar"), "", false);
    }
    ...
    public File testTar() {
        ...
        File srcFile = new File("D:/log/2017back.txt");//要归档的文件对象

        File targetTarFile = new File("D:/log/2018back.tar");//归档后的文件名
